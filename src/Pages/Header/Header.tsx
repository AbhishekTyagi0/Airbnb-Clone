...
const Header: React.FC = () => {
  return (
    <div className="flex flex-col justify-center items-center border-b border-gray-200 pb-8">
      <div className="w-full h-auto flex justify-between px-14 py-5">
        <div className="flex justify-center items-center">
          <img src={airbnb} className="h-10" alt="logo" />
        </div>
        <div className="flex gap-12 pl-20 ml-20 flex-1 text-gray-500 justify-center items-center">
      ...
      <div className="w-4/6 h-auto flex justify-between border border-gray-300 p-2 rounded-full shadow-lg">
        ...
        <div className="flex flex-col w-1/6 px-10 justify-center items-start hover:bg-gray-200 hover:rounded-full border-r border-gray-200">
        ...
        <div className="flex flex-1  pl-10 justify-between items-center hover:bg-gray-200 hover:rounded-full">
